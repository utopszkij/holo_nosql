...
class DocumentHandler {
	...
	*/
	public _insert() : void {
		...
		var i : number = 0;
		var key : string;
		var linkBase : string = App.DNA.Hash;
 		entry.doc = this.doc;
 		if (this.doc.cName == 'collections') {
	...
	*/
 	public doFind(cName : string, propName : string,
 		...
 		var i : number;
		var dh : DocumentHandler;
		var collection : DocumentHandler;
		var linkBase : string = App.DNA.Hash;
		dh = new DocumentHandler();
 		...
 		var w : GetLinksResponse[] = getLinks(linkBase,
						 				 tag,
...
debug('\nvalidateCommit B '+res);
	}
debug('\nvalidateCommit end '+res);
	return res;
}
